...
public class JavaProgrammingFragment extends Fragment implements LoaderManager.LoaderCallbacks<String> {
     ...
     */
    private RecyclerView javaProgrammingRecyclerview;
    private RecyclerView.Adapter topicAdapter;
    private List<JsonDataList> jsonDataListsMain;
    private int gridCount;
    private Bundle bundle;
    private String placeholderString = "java";

    public JavaProgrammingFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_java_programming, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
         ...
         */
        javaProgrammingRecyclerview = getActivity().findViewById(R.id.java_programming_recyclerview);
        javaProgrammingRecyclerview.setHasFixedSize(true);
        gridCount = calculateNoOfColumns(getActivity());
        javaProgrammingRecyclerview.setLayoutManager(new GridLayoutManager(getContext(), gridCount));
         ...
         */
        bundle = new Bundle();
        bundle.putString("url", Contract.JAVA_JSON_URL);
        ...
        if (data != null) {
            ...
            try {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    javaProgrammingRecyclerview.setAdapter(topicAdapter);
